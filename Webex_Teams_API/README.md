Task name => Webex_Teams_API

Task preparation => what preparation is necessary to perform the task?
First we make a folder named Webex_Teams_API where we will put all the needed files inside.

Task implementation => what is the way you have implemented this? (python code)
This script will create a new room with all the members their email address. This script will use your private developers webex token to connect to your profile create the group, send a message to the group.
...
Task troubleshooting => what were the problems encountered? Did not have problems

Task verification => proof of the quality of the result
https://github.com/DannyRodriguezRincon/Devasc-Skills_DannyRodriguez/blob/5be5b98663abc3223b417ac19c22eea7cd613f4f/Webex_Teams_API/Webex_Teams_Chat_Proof.png
